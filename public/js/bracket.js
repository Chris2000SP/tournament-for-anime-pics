...
function initializeBracket() {
    ...
    const numRounds = Math.ceil(Math.log2(numParticipants)) + 1; // hier war der Fehler gewesen sagte Chris
    const totalSlots = Math.pow(2, numRounds) / 2; // hier war auch ein Fehler
...
function findNextMatch() {
    for (let round = 0; round < bracketData.length - 1; round++) {
